...
#define LOG_INFO "[INFO] (" << __FILE__ << ":" << __LINE__ << "): "
#define LOG_ERROR "[ERROR] (" << __FILE__ << ":" << __LINE__ << "): "
...
enum OPCODES {
    // R-type opcodes
    OP_INT = 0b0110011,  // Integer ALU instructions add, sub, sll, slt, sltu,
                         // xor, srl, sra, or, and
    OP_INTW = 0b0111011, // Integer ALU instructions on 32-bit words addw, subw,
                         // sllw, srlw, sraw
    // I-type opcodes
    OP_LOAD = 0b0000011,    // Load instructions lb, lh, lw, ld, lbu, lhu, lwu
    OP_INTIMM = 0b0010011,  // Integer ALU immediate instructions addi, slli,
                            // slti, sltiu, xori, srli, srai, ori, andi
    OP_INTIMMW = 0b0011011, // Integer ALU immediate instructions on 32-bit
                            // words addiw, slliw, srliw, sraiw
...
Status dumpSimStats(SimulationStats &stats,
